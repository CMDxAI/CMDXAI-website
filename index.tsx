        ...
        <div className="md:hidden bg-white border-t border-gray-100 absolute w-full shadow-xl">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4 flex flex-col space-y-3">
              <a
                href="#"
                className="text-center text-gray-700 font-bold py-2 border border-gray-200 rounded-lg"
              >
                Login
              </a>
              <a href="#" className="text-center bg-blue-600 text-white font-bold py-3 rounded-lg">
                Register
              </a>
            </div>
          </div>
...
const Carousel = () => {
  ...
  return (
    <div className="relative w-full h-[600px] overflow-hidden bg-gray-900">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-30 p-2 bg-white/10 hover:bg-white/20 rounded-full text-white backdrop-blur-sm transition-colors"
      >
        <ChevronLeft />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-30 p-2 bg-white/10 hover:bg-white/20 rounded-full text-white backdrop-blur-sm transition-colors"
      >
        <ChevronRight />
      </button>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our team of expert instructional designers and developers work as an extension of your
              team. We don't just build courses; we craft learning experiences that drive behavioral
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Unlock the power of mobile to boost your business, reach more audiences, and engage
          ...
          <div className="lg:w-1/2 relative flex justify-center items-center">
            ...
            <div className="relative z-10 mx-auto">
              ...
              <div
                className="absolute top-1/4 -left-8 md:-left-20 bg-white p-3 rounded-xl shadow-xl border border-gray-100 hidden sm:block w-36 md:w-44 animate-bounce-slow"
                style={{ animationDuration: '4s' }}
              >
                <div className="h-24 bg-gray-100 rounded-lg mb-2 overflow-hidden relative">
                  <img
                    src="https://images.unsplash.com/photo-1571260899304-425eee4c7efc?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80"
              ...
              <div
                className="absolute bottom-1/4 -right-8 md:-right-20 bg-white p-4 rounded-xl shadow-xl border border-gray-100 hidden sm:block w-36 md:w-44 animate-bounce-slow"
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              We are a collective of senior engineers, architects, and educators who have been
              shaping the eLearning landscape for over two decades. Since our inception, we have
              dedicated ourselves to mastering the art of open-source application development.
            </p>

            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Our expertise isn't just in deployment; it's in the deep customization and
              architectural optimization of platforms like Moodle, Totara, and Open edX. We build
              enterprise-grade applications that are robust, secure, and infinitely scalable,
              leveraging the true power of open-source communities.
            </p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    PHP, React, Python, & Cloud Architecture experts.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Active contributors to major open-source projects.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full animate-fade-in-up text-center">
        ...
        <p className="text-gray-600 mb-6">
          Thank you for contacting CMDx. We have received your message and will get back to you
          shortly.
        </p>
        <button
          onClick={onClose}
...
const ContactForm = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    const mailtoLink = `mailto:naveen.m@cmdx.ai?subject=${subject}&body=${body}`;
